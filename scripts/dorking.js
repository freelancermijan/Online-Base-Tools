...
function googleSearch(google) {
    ...
    switch (google) {
        ...
        case 5:
            ...
            break;
        case 6:
            searchQuery += ' inurl:login | inurl:wp-admin';
            break;
        case 7:
        ...
        case 41:
            ...
            break;
        case 42:
            searchQuery += ' inurl:/admin.aspx | inurl:/admin.php | inurl:/admin.html | inurl:/login.aspx | inurl:/login.php | inurl:/login.html'
            break
        case 43:
            searchQuery += ' inurl:/wp-content/uploads/wpo_wcpdf'
            break
        case 44:
            searchQuery += ' inurl:uploadimage.php | inurl:upload.php | inurl:upload.html | inurl:fileupload.php'
            break
        case 45:
...
// bugbountyplatforms
function bugbountyplatformsSearch(bugbountyplatforms) {
    var targetDomain = document.querySelector('.target').value;
...
// webarchive
function webarchive(webarchive) {
    var targetDomain = document.querySelector('.target').value;
...
function socialmedia(socialmedia) {
    ...
    switch (socialmedia) {
        ...
        case 2:
            var site = 'site:facebook.com employees ' + targetDomain;
            var url = 'https://www.google.com/search?q=' + encodeURIComponent(site);
            window.open(url, '_blank');
            return;

        case 3:
            var site = 'site:twitter.com employees ' + targetDomain;
            var url = 'https://www.google.com/search?q=' + encodeURIComponent(site);
            window.open(url, '_blank');
            return;

        case 4:
            var site = 'site:youtube.com employees ' + targetDomain;
            var url = 'https://www.google.com/search?q=' + encodeURIComponent(site);
            window.open(url, '_blank');
            return;

        case 5:
            var site = 'site:instagram.com employees ' + targetDomain;
            var url = 'https://www.google.com/search?q=' + encodeURIComponent(site);
            window.open(url, '_blank');
            return;

        case 6:
            var site = 'site:mail.google.com employees ' + targetDomain;
            var url = 'https://www.google.com/search?q=' + encodeURIComponent(site);
            window.open(url, '_blank');
            return;
